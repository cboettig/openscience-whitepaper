...
- ***A*** Why is open science important for transforming research and learning? 
- ***B*** What are the major technical, organizational, social, or cultural challenges you face, particularly as related to openness and sharing within your university and academia?
- ***C*** How can open science increase the societal impact of university research?
...
funders such as NIH, Buroughs Welcomme Fund, as well as institutional requirements
...
open access journals [@Dryad].  No doubt this reflects the relative absence of
...
route to an individual researcher's own objectives).  The challenges and opportunites
...
### Open context (open notebooks, open protocols, etc)

These elements have received the least attention -- it is not yet clear
if "open context" is the right term or if these elements should truly be lumped together.
Such elements face a more fundamental division from those previously discussed
in that they shift the focus from *product* to *process*. In some ways this
...
- **Lab Notebook**: I maintain an open lab notebook since 2010 at <https://carlboettiger.info>.  Since 2015 this has been maintained in a `notebook` directory of specific projects on GitHub.  

### Teaching

I teach a graduate course, [Reproducible and Collaborative Data Science](http://berkeley.carlboettiger.info/espm-88b) and an undergraduate course: [Data Science in Ecology and the Environment](https://ds421.github.io/rcds) that both emphasize the practices, principles and tools of open science reproducible research.  I make all of my teaching materials for the course publicly available under an open, permissive CC-BY license with source code on GitHub repositories.  

### Service

I am senior fellow at the Berkeley Institute for Data Science where I am a member of the Open Science and Reproducible Research working group.  The working group has just published a book on reproducible research in which I contributed a chapter on my current workflow:  

At a national level, I serve as a Science Adviser to the National Center for Ecological Analysis and Synthesis (NCEAS), which has been an early and important supporter of open science practices, including the Open Science for Synthesis program and an Open Science Codefest.  I also serve on the User Board for the  NSF Jetstream supercomputing center, where I try to serve as an advocate for an open and inclusive view of high performance computing.


## If you had a senior leadership role in a university, what would you do to promote change and improve your university?

Open science practices often fall outside the standard academic scope of incentives and the currency of hiring and promoting.  It is possible and can be effective to align these objectives whenever possible: for instance, software papers can translate software development into a more traditional currency of publication and citation, and certain grant opportunities may look favorably on open science goals and practices, and a researcher recognized for these practices may enjoy less tangiable benefits of recognition. Yet for the most part these efforts will be at odds with the expectation to publish regularly in prestigious venues which makes up the cornerstone of scientific reward.  The best thing senior university leadership can do to promote open science would be to protect and encourage these practices among junior faculty.  
